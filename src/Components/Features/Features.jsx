...
const Features = () => {
    return (
        <div>
            <div className="hero min-h-screen bg-fixed" style={{ backgroundImage: 'url(https://i.ibb.co/VV24y20/featured.jpg)' }}>
                ...
                <div className="p-10">
                    ...
                    <div className="flex justify-center items-center w-2/3 mx-auto gap-10">
                        ...
                        <div className="text-white">
                            ...
                            <h3 className="text-lg uppercase">WHERE CAN I GET SOME?</h3>
