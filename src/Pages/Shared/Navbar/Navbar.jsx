    ...
    return (
        <div className="navbar z-10 max-w-7xl mx-auto bg-opacity-60 bg-black text-white fixed">
            <div className="w-[30%]">
                ...
                <button className="btn btn-ghost normal-case text-xl flex justify-center items-center w-64"><img className="w-[10%]" src="https://i.ibb.co/z6RN3WD/logo.png" alt="" /> Bistro Boss</button>
